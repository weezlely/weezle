...
import React__default, { createContext, useLayoutEffect, useEffect, useContext, useRef, useInsertionEffect, useCallback, useMemo, forwardRef, Fragment, createElement, useId, useState } from 'react';
...
function useCreateMotionContext(props) {
  var _getCurrentTreeVarian = getCurrentTreeVariants(props, useContext(MotionContext)),
...
function createMotionComponent(_ref) {
  ...
  function MotionComponent(props, externalRef) {
     ...
     */
    var MeasureLayout;
    var configAndProps = _objectSpread2(_objectSpread2(_objectSpread2({}, useContext(MotionConfigContext)), props), {}, {
    ...
    return /*#__PURE__*/React.createElement(MotionContext.Provider, {
      value: context
    }, MeasureLayout && context.visualElement ? ( /*#__PURE__*/React.createElement(MeasureLayout, _objectSpread2({
  ...
  var ForwardRefComponent = /*#__PURE__*/forwardRef(MotionComponent);
...
function createUseRender() {
  ...
  var useRender = function useRender(Component, props, ref, _ref, isStatic) {
    ...
    var elementProps = Component !== Fragment ? _objectSpread2(_objectSpread2(_objectSpread2({}, filteredProps), visualProps), {}, {
      ref: ref
    }) : {};
    /**
    ...
    return /*#__PURE__*/createElement(Component, _objectSpread2(_objectSpread2({}, elementProps), {}, {
...
function MeasureLayout(props) {
  ...
  return /*#__PURE__*/React__default.createElement(MeasureLayoutWithContext, _objectSpread2(_objectSpread2({}, props), {}, {
...
var BottomSheetContext$1 = createContext({
    onDragEnd: function () { },
    controls: undefined,
    setIsOpen: function () { },
    isOpen: true,
});
var useBottomSheetContext = function () { return useContext(BottomSheetContext$1); };
...
function usePreviousValue(isOpen) {
    ...
    var previousValueRef = useRef(isOpen);
    useEffect(function () {
...
var BottomSheetContext = createContext({
    onDragEnd: function () { },
    controls: undefined,
    setIsOpen: function () { },
    isOpen: true,
...
var BottomSheetProvider = function (_a) {
    ...
    return jsx(BottomSheetContext.Provider, { value: { onDragEnd: onDragEnd, controls: controls, setIsOpen: setIsOpen, isOpen: isOpen }, children: children });
};
...
var BottomSheetWrapper = function (_a) {
    ...
    return (jsx(motion.div, __assign({ initial: initial, drag: dragDirection, animate: controls, onDragEnd: onDragEnd, transition: {
            type: "spring",
            damping: 40,
            stiffness: 400,
        }, variants: {
...
var BottomSheetHeader = function (_a) {
    ...
    return (jsx(motion.div, __assign({ animate: controls, style: __assign(__assign({}, header), style) }, rest, { children: children })));
};
var BottomSheetContents = function (_a) {
    var style = _a.style, children = _a.children, rest = __rest(_a, ["style", "children"]);
    var controls = useBottomSheetContext().controls;
    return (jsx("div", __assign({ onClick: function () { return controls === null || controls === void 0 ? void 0 : controls.stop(); }, style: __assign(__assign({}, contents), style) }, rest, { children: children })));
};
...
var HelloWrapper = function () {
    return jsx("div", { id: "component", children: "Hello World!" });
};
...
var Button = function () {
    return jsx("div", { children: "Button" });
};

export { BottomSheet, Button, Hello, useBottomSheet, usePreviousValue };
