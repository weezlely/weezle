...
import type { ComponentProps, DragEndEventHandler } from "../../types";
...
export interface BottomSheetWrapperProps extends ComponentProps<MotionDivElement> {
...
export interface BottomSheetHeaderProps extends ComponentProps<MotionDivElement> {}

// Bottom Sheet's Body
export interface BottomSheetBodyProps extends ComponentProps<HTMLElement> {}
