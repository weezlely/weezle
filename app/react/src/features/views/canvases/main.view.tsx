...
import { CanvasEditorProvider, ExampleCanvasEditor, ExampleCanvasEditorToolbar } from "@/shared/components";

import { uesPageWrapperStore } from "@/state";
import { BaseCard, Markdown } from "@/shared/components";

import { canvasMainResponse } from "@/_db";

export const CanvasMainView = () => {
